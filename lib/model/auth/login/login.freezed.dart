...
class _$LoginImpl implements _Login {
  const _$LoginImpl(
      {this.token, @JsonKey(name: 'login_by') this.loginType, this.user});
  ...
  @override
  String toString() {
    return 'Login(token: $token, loginType: $loginType, user: $user)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, token, loginType, user);
...
abstract class _Login implements Login {
  const factory _Login(
      {final String? token,
      @JsonKey(name: 'login_by') final String? loginType,
      final User? user}) = _$LoginImpl;
