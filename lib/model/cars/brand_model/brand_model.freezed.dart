...
abstract class $BrandModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, int? brandId, String? name});
}
...
class _$BrandModelImpl implements _BrandModel {
  const _$BrandModelImpl({this.id, this.brandId, this.name});
  ...
  @override
  String toString() {
    return 'BrandModel(id: $id, brandId: $brandId, name: $name)';
  }
...
abstract class _BrandModel implements BrandModel {
  const factory _BrandModel(
      {final int? id,
      final int? brandId,
      final String? name}) = _$BrandModelImpl;
